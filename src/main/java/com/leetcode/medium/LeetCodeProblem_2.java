 ...
 *
 */
public class LeetCodeProblem_2 {
    ...
    public ListNode addTwoNumbers1(ListNode l1, ListNode l2) {
        return calculateSumRecursive(l1, l2, 0);
    }


    private ListNode calculateSumRecursive(ListNode l1, ListNode l2, int carry) {
        ...
        newNode.next = calculateSumRecursive(l1, l2, sum / 10);
        return newNode;
    }
